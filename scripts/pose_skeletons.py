...
POSES = {
 ...
 # death: figure collapsed / lying horizontal near the ground, head to the left
 "death": {0:(300,720),1:(390,712),2:(400,668),3:(470,650),4:(540,660),5:(402,756),
   6:(474,772),7:(544,772),8:(560,700),9:(660,690),10:(760,700),11:(560,740),
   12:(664,752),13:(766,752),14:(288,706),15:(292,734),16:(300,700),17:(306,742)},
}
