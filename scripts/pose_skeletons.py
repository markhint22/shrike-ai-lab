...
POSES = {
 ...
 # DOWNED (wounded-but-alive): collapsed on the ground, torso ANGLED UP propped on one
 # arm, head up-left, legs sprawled/bent to the right. Distinct from flat 'death' so it
 # reads as hurt-and-prone, not a tidy corpse and not standing.
 "downed": {0:(340,560),1:(380,606),2:(406,600),3:(432,662),4:(452,722),5:(410,626),
   6:(456,662),7:(502,690),8:(472,690),9:(562,700),10:(652,690),11:(482,706),
   12:(556,740),13:(646,730),14:(332,552),15:(352,552),16:(326,562),17:(360,560)},
}
