...
POSES = {
 ...
 # DOWNED (wounded-but-alive): KNEELING — collapsed onto one knee, head bowed, one arm
 # clutching a wound. NOT lying (that read as standing) and NOT upright. One leg's knee
 # is on the ground (shin back), the other foot is planted forward.
 "downed": {0:(500,360),1:(505,432),2:(462,444),3:(447,522),4:(458,596),5:(551,444),
   6:(566,520),7:(560,596),8:(480,602),9:(470,716),10:(452,816),11:(537,602),
   12:(560,700),13:(576,800),14:(490,352),15:(514,352),16:(478,362),17:(526,362)},
}
