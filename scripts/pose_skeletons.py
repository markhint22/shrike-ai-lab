...
POSES = {
 ...
 # MELEE attack (aliens): hunched forward LUNGE, both arms thrust forward to strike
 # with claws/fists (no weapon), front leg lunging - reads as a punch/claw lunge
 "attack_melee": {0:(512,262),1:(512,336),2:(450,346),3:(452,438),4:(492,516),
   5:(574,346),6:(572,438),7:(532,516),8:(476,548),9:(506,662),10:(556,760),
   11:(554,548),12:(556,690),13:(560,834),14:(500,254),15:(524,254),16:(482,262),17:(542,262)},
