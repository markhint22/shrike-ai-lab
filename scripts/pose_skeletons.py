...
POSES = {
 ...
 # walk2 = opposite stride (L leg forward, R arm forward) - the other half of a
 # 2-frame walk cycle, alternated with "walk".
 "walk2": {0:(508,214),1:(510,302),2:(445,314),3:(420,404),4:(404,484),5:(575,314),
   6:(602,410),7:(616,500),8:(470,544),9:(484,686),10:(519,832),11:(550,544),
   12:(518,664),13:(476,782),14:(494,204),15:(522,204),16:(474,216),17:(540,216)},
