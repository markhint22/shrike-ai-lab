...
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/data/repository/BillsRepositoryTest.kt — Add test case for `untrackBill` success, verifying DataStore removal. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.data.repository.BillsRepositoryTest.untrackBillRemovesFromDataStore"` passes. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/ui/screens/BillsViewModelTest.kt — Create test class with mockk setup for BillsRepository, implementing `loadBills` initial state verification. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.ui.screens.BillsViewModelTest.loadBillsInitial"` passes. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/ui/screens/BillsViewModelTest.kt — Add test case for `loadBills` success, verifying state transition to Success with data. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.ui.screens.BillsViewModelTest.loadBillsSuccess"` passes. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/ui/screens/BillsViewModelTest.kt — Add test case for `loadBills` failure, verifying state transition to Error. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.ui.screens.BillsViewModelTest.loadBillsError"` passes. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/ui/screens/BillsViewModelTest.kt — Add test case for `toggleTracking`, verifying repository call and state update. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.ui.screens.BillsViewModelTest.toggleTrackingUpdatesState"` passes. (cat:test; multifile:no)
...
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/data/repository/BillingRepositoryTest.kt — Create test class with mockk setup for BillingRepository dependencies and verify initialization. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.data.repository.BillingRepositoryTest"`. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/data/repository/BillingRepositoryTest.kt — Add test for `isPremiumUser()` returning true when billing client reports active subscription. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.data.repository.BillingRepositoryTest.isPremiumUser_returnsTrueWhenActive"`. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/data/repository/BillingRepositoryTest.kt — Add test for `isPremiumUser()` returning false when billing client reports no active subscription. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.data.repository.BillingRepositoryTest.isPremiumUser_returnsFalseWhenInactive"`. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/data/repository/BillingRepositoryTest.kt — Add test for `purchasePremium()` handling successful purchase flow. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.data.repository.BillingRepositoryTest.purchasePremium_successFlow"`. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/data/repository/BillingRepositoryTest.kt — Add test for `purchasePremium()` handling billing error exceptions. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.data.repository.BillingRepositoryTest.purchasePremium_errorHandling"`. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/ui/screens/BillingViewModelTest.kt — Create test class with mockk setup for BillingViewModel dependencies and verify initialization. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.ui.screens.BillingViewModelTest"`. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/ui/screens/BillingViewModelTest.kt — Add test for `init` block updating UI state based on repository premium status. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.ui.screens.BillingViewModelTest.init_updatesStateBasedOnPremiumStatus"`. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/ui/screens/BillingViewModelTest.kt — Add test for `onPurchaseClick()` triggering repository purchase and updating state on success. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.ui.screens.BillingViewModelTest.onPurchaseClick_successUpdatesState"`. (cat:test; multifile:no)
- [ ] [T1] billwatch-android/app/src/test/java/com/billwatch/ui/screens/BillingViewModelTest.kt — Add test for `onPurchaseClick()` handling repository failure and updating error state. VERIFY: `./gradlew :app:testDebugUnitTest --tests "com.billwatch.ui.screens.BillingViewModelTest.onPurchaseClick_failureUpdatesErrorState"`. (cat:test; multifile:no)
...
- [ ] [T1] billwatch-web/src/components/__tests__/UnifiedBillCard.test.ts — Create test file with basic mount of UnifiedBillCard using default props and assert it renders without error. VERIFY: `cd billwatch-web && npx vitest run src/components/__tests__/UnifiedBillCard.test.ts`. (cat:test; multifile:no)
