# Grooming proposal — shrike-monitor — 2026-09-24 04:00
...
1. Add unit tests for `backend/app/utils/percentile.py` covering empty lists, single values, and p50/p95 calculations on a known dataset.
...
3. Add unit tests for `backend/app/utils/status_streak.py` ensuring it correctly identifies the longest consecutive run of a specific status (e.g., 'down') in a result history.
